...
class _ItesoScreenState extends State<ItesoScreen> {
  ...
  String imageUrl = "https://www.cisco.com/c/m/es_mx/cases/iteso/jcr:content/Grid/category_atl_26d4/layout-category-atl/marquee_inpage_505b.img.jpg/1549279992740.jpg";
            ...
            child: Row(
              children: [
                Expanded(
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text("ITESO, Universidad Jesuita de Guadalajara",
                      style: TextStyle(
                        fontSize: 20.0,
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    child: Icon(Icons.thumb_down, color: isPressedDown ? Colors.blue : Colors.grey,),
                    onTap: () {
                      setState(() {
                        if (isPressedDown) {
                          // blue color
                ...
                GestureDetector(
                  child: Icon(Icons.thumb_up, color: isPressedUp ? Colors.blue : Colors.grey,),
                  onTap: () {
                    setState(() {
                        if (isPressedUp) {
                          // blue color
...
void getSnackBar(String msg, context){
  SnackBar snackBar = SnackBar(
    ...
    content: Text(msg, textAlign: TextAlign.center, style: TextStyle(fontSize: 18.0),),
  );
